...
extern keylist_t compr_keylist;
...
unsigned char * crypt_data_d(unsigned char *open_data, int len_open_data,
                            unsigned char *key, int len_key,
                            unsigned char *sp, int len_sp, int *len_crypted_data);
