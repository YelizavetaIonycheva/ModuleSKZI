...
/*****************************************************************/
//Программная реализация алгоритма хэширования по ГОСТ 34.11-12 (512 бит)
//На входе:
//		- указатель на структуру с данными
/*****************************************************************/
unsigned short Hesh341112(HeshStruct * Data)
{
	unsigned int i, j = 0;
	unsigned int len;
	unsigned char *h, *mm;
	...
	if((Data == NULL) || (Data->Data == NULL) || (Data->Hesh == NULL))
		return 0;
	if(Data->STATE == TR_NO)
	{
		//Этап 1
